          ...
          {services.slice(0, 4).map((service, i) => (
            ...
            >
              <Link
                ...
                className="group bg-card border border-border rounded-xl p-6 hover:border-gradient-pink/40 transition-all duration-300 hover:-translate-y-1 block h-full"
              >
